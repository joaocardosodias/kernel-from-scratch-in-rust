...
pub extern "x86-interrupt" fn general_protection_fault(_stack_frame: &mut InterruptStackFrame) {
    println!("General protection Fault");
    loop {}
}
pub extern "x86-interrupt" fn page_fault(_stack_frame: &mut InterruptStackFrame) {
    println!("Page fault");
    loop {}
}
